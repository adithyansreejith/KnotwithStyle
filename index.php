...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Knot with Style</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Knot with Style</h1>
          <p class="intro-subtitle"><span class="text-slider-items">Plan your dream wedding, Anywhere, Anytime!</span><strong class="text-slider"></strong></p>
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico">
                      ...
                      <li><span class="ion-ios-telephone"></span> +9199999999999</li>
                      <li><span class="ion-email"></span>bhavana@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
          ...
          <div class="col-sm-12">
            <div class="copyright-box">
              <div class="credits">
                ...
                -->
                Designed by <a href="#">Bhavana Unnikrishnan</a>
              </div>
            </div>
          </div>
        </div>
